...
class ManageBlocksButton(private val mine: NormalMine) : Button() {
    ...
    override fun getDescription(player: Player): List<String> {
        return arrayListOf<String>().also { desc ->
            desc.add("")
            desc.addAll(TextSplitter.split(text = "Manage this mine's blocks configuration."))
            desc.add("")
            desc.add("${ChatColor.GREEN}${ChatColor.BOLD}LEFT-CLICK ${ChatColor.GREEN}to manage config")
        }
    }
