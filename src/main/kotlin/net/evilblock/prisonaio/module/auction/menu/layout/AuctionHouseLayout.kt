...
package net.evilblock.prisonaio.module.auction.menu.layout
...
object AuctionHouseLayout {
    ...
    @JvmStatic
    fun renderListingExpiration(listing: Listing, list: MutableList<String>) {
    ...
    @JvmStatic
    fun renderListingStatus(player: Player, listing: Listing, list: MutableList<String>) {
    ...
    @JvmStatic
    fun renderListingInformation(player: Player, listing: Listing, list: MutableList<String>) {
