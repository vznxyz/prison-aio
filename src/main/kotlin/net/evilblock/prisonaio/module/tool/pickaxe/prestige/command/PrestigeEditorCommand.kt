...
package net.evilblock.prisonaio.module.tool.pickaxe.prestige.command

import net.evilblock.cubed.command.Command
import net.evilblock.prisonaio.module.tool.pickaxe.prestige.menu.PrestigeEditorMenu
