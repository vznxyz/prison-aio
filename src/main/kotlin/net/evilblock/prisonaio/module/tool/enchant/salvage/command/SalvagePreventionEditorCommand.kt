...
package net.evilblock.prisonaio.module.tool.enchant.salvage.command

import net.evilblock.cubed.command.Command
import net.evilblock.prisonaio.module.tool.enchant.salvage.menu.SalvagePreventionEditorMenu
