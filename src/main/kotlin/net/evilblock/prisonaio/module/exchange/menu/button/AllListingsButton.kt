...
class AllListingsButton : TexturedHeadButton(Constants.IB_GLOBE_TEXTURE) {
    ...
    override fun getDescription(player: Player): List<String> {
        return arrayListOf<String>().also {
            it.add("")
            it.addAll(TextSplitter.split(text = "Shows you all the listings in The Grand Exchange, filtered and sorted how you want by using the controls in the top right of the menu."))
            it.add("")
