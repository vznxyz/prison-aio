...
class GangGuideNPC(location: Location) : NpcEntity(listOf(""), location) {
    ...
    override fun onRightClick(player: Player) {
        ...
        if (canOpen) {
            ...
            player.sendMessage("${ChatColor.RED}The Guard yells: `You know the rules, ${player.name}! No talking to guards!`")
            player.sendMessage("${ChatColor.RED}(You don't have access to this cell)")
        }
    }
